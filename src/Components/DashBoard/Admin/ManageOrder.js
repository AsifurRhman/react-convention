...
const ManageOrder = () => {
    ...
    const { data: allorders, isLoading, refetch } = useQuery('allorders', () => fetch(`https://royal-convention-server.vercel.app/order`, {
        method: 'GET',
        headers: {
    ...
    //     fetch(`https://royal-convention-server.vercel.app//order/${id}`, {
    //         method: 'DELETE',
    //         headers: {
